...
parser.add_argument('--model_name', default='roam_malc_sup', type=str, metavar='PATH',
...
def train(train_loader, model, optimizer, epoch, train_criterion):
    model.train()
    count = 0
    tr_loss = 0
...
def run_train(model, train_loader, valid_loader, optimizer, train_criterion, validation_criterion):
    ...
    for epoch in range(0, args.epochs):
        ...
        train(train_loader, model, optimizer, epoch, train_criterion)
